...
cl =LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EpDC99vhgNkAqQvaRz6c.YLgVP2FFH7O3buLlL8m1xa.B6yXjo1eNH+noImqCNXNek6QrqYtsOSB04mz8V8C5g4')
cl.loginResult()

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EprIpb4rvXSzYT3JVeK7.MRMd87JLMY8NA0SCe7JEXW.etYvXTBjtuzRregGaoI89kZsPWBevBb7zLtfXhiIc2Y')
ki.loginResult()

ki2 = LINETCR.LINE()
#ki2.login(qr=True)
ki2.login(token='EpAYDe0vGLjMPIO3WK3d.vbNv/Ahkjt2nxvzeJY8hlq.Uq0gCtMxLzJGJ81rshNBFqmEtb93OtdjXrpn19FONqk')
ki2.loginResult()

ki3 = LINETCR.LINE()
#ki3.login(qr=True)
ki3.login(token='EpbYt3gKooLOD5fMtCq2.zndSNT2YNzxghldUFVf90G.Odi+03qP1gz7ba2dIuuQz59rpIG6PcWALiXznOlvGgc')
ki3.loginResult()

ki4 = LINETCR.LINE()
#ki4.login(qr=True)
ki4.login(token='EpbYt3gKooLOD5fMtCq2.zndSNT2YNzxghldUFVf90G.Odi+03qP1gz7ba2dIuuQz59rpIG6PcWALiXznOlvGgc')
ki4.loginResult()

ki5 = LINETCR.LINE()
#ki5.login(qr=True)
ki5.login(token='EpLEHYWlVeQ0ZN1Lpele.zmCv8kW3miEalfHutIIt+G.g2YtMAZwtOJAAtXF75yFaclnTyEsWrpw74A90x5GnSQ')
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token='EpLEHYWlVeQ0ZN1Lpele.zmCv8kW3miEalfHutIIt+G.g2YtMAZwtOJAAtXF75yFaclnTyEsWrpw74A90x5GnSQ')
ki6.loginResult()
...
||======= FOR ADMIN =======||
 ...
 ||==== K̲̲̅̅ ̲̲̅̅I̲̲̅̅ ̲̲̅̅E̲̲̅̅B̲̲̅̅O̲̲̅̅ ̲̲̅̅T̲̲̅̅ ̲̲̅̅L̲̲̅̅O̲̲̅̅V̲̲̅̅E̲̲̅̅L̲̲̅̅N̲̲̅̅E̲=====||
╔════☬════♪•●☬●•♪════☬═══╗
...
||==============================||
✯★Creator By   ||======== K̲̲̅̅ ̲̲̅̅I̲̲̅̅ ̲̲̅̅E̲̲̅̅B̲̲̅̅O̲̲̅̅ ̲̲̅̅T̲̲̅̅ ̲̲̅̅L̲̲̅̅O̲̲̅̅V̲̲̅̅E̲̲̅̅L̲̲̅̅N̲̲̅̅E̲===========||
