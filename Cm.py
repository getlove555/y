...
cl =LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='ErB0dURCtITkpsXRlWs2.lJ5bGqDlfSu1lZooRbFQ4G.lQ/SxJV/idWQLIhAIiJJ0F6EcAxdKWWoXUKIqRJE9eM=')
cl.loginResult()
    ...
    try:
        ...
        if op.type == 5:
            if wait["autoAdd"] == True:
                cl.findAndBlockContactsByMid(op.param1)
                if (wait["message"] in [""," ","\n",None]):
                    pass
                else:
