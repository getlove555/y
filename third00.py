...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='EoFpFxOPe6ZaXzcdiK11.QVs5KnXt8NCFv9eWVB+fyq.UJGXp5sji9Vkha3aLhVujyvGWWk8tE+xudmV4/Hj4zQ=')
nadya.loginResult()
...
╚═════════════════════════
"""
tjia="uaaf4b990dc53f2771f57d130bdbfc561"
...
Bots=[mid]
Creator=["uaaf4b990dc53f2771f57d130bdbfc561","ueacedbe88bf6e2c5cf6188b3a4a26e18"]
admin=["uaaf4b990dc53f2771f57d130bdbfc561","ueacedbe88bf6e2c5cf6188b3a4a26e18"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By :คุนหนู👧☺️ .",    
    "commentOn":True,
    "commentBlack":{},
...
def bot(op):
    try:
		...
		nadya.sendText(msg.to,"Itu Majikan Kami (^_^)")
                ...
                msg.contentType = 13
                admin1 = "uaaf4b990dc53f2771f57d130bdbfc561"
                admin2 = "uaaf4b990dc53f2771f57d130bdbfc561"
                admin3 = "uaaf4b990dc53f2771f57d130bdbfc561"
                msg.contentMetadata = {'mid': tjia}
                nadya.sendMessage(msg)
		...
		if midd not in admin:
		    ...
		    nadya.sendText(msg.to,"Admin Detected")
                ...
                midd = "uaaf4b990dc53f2771f57d130bdbfc561"
                nadya.inviteIntoGroup(msg.to,[midd])
