...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By : THIRD : 👉 line.me/ti/p/4bvwOIMft8  ^_^.",    
    "commentOn":True,
    "commentBlack":{},
    "message":"Thx For Add Me (^_^)\nยินดีที่ได้รู้จักヘ(^_^)ヘ",    
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Qr":False,
    ...
    try:
        ...
        if op.type == 15:
          if wait["Sambutan"] == True:
            if op.param2 in Creator:
                return
            nadya.sendText(op.param1,"บ๊ายบาย " + nadya.getContact(op.param2).displayName +  "\nแร้วเจอกัลใหม่นะ . . . (p′︵‵。) 🤗")
...
#            elif "รันกลุ่ม" in msg.text:
 #               thisgroup = nadya.getGroups([msg.to])
  #              Mids = [contact.mid for contact in thisgroup[0].members]
   #             mi_d = Mids[:33]
    #            nadya.createGroup("What..The..FucK", mi_d)
   #             nadya.sendText(msg.to,"•─ ͜͡✫What..The..FucK ͜͡✫─•\n🏂⛷️[What..The..FucK]")
